...
//     const userSkillsList = userSkills.skills.map(skill => skill.toLowerCase());
...
//         const jobRequirementsList = job.requirements.map(req => req.toLowerCase());
//         let matchCount = 0;

//         for (const requirement of jobRequirementsList) {
//           for (const skill of userSkillsList) {
//             if (requirement.includes(skill) || skill.includes(requirement)) {
//               matchCount++;
//               break; // Avoid double counting the same requirement
//             }
//           }
//         }

//         score = matchCount / jobRequirementsList.length;
//       }

//       const matchScorePercentage = parseFloat((score * 100).toFixed(2));
